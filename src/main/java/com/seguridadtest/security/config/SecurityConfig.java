package com.seguridadtest.security.config;

import com.seguridadtest.security.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtTokenProvider jwtTokenProvider, @Lazy UserDetailsServiceImpl userDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/auth/all-user").hasRole("USER")
